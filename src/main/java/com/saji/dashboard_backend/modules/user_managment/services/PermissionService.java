...
public class PermissionService {
    ...
    public PermissionService(PermissionRepo permissionRepo, PermissionMapper permissionMapper) {
    ...
    public PermissionDto update(Long id, PermissionDto req) {
        ...
        return permissionMapper.convertEntityToResponse(permission);
    }
}
